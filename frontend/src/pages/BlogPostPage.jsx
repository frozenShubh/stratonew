...
const BlogPostPage = () => {
    ...
    return (
      <div className="min-h-screen bg-[#020507]">
        ...
        <div className="pt-32 pb-24 text-center">
          ...
          <Link to="/blog" className="text-[#539AC1] hover:text-[#A5C7E0]">
            ← Back to Blog
          </Link>
        </div>
        <Footer />
  ...
  return (
    <div className="min-h-screen bg-[#020507]">
      <Helmet>
        <title>{post.title} | Stratosport Blog</title>
        <meta name="description" content={post.excerpt} />
        <meta property="og:title" content={`${post.title} | Stratosport`} />
        <meta property="og:description" content={post.excerpt} />
        <meta property="og:type" content="article" />
        <link rel="canonical" href={`https://stratosport.in/blog/${post.slug}`} />
      ...
      <section className="pt-32 pb-12 bg-gradient-to-br from-[#0D4669]/20 via-[#020507] to-[#033051]/20 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          >
            <Link to="/blog" className="inline-flex items-center text-[#539AC1] hover:text-[#A5C7E0] text-sm mb-8 transition-colors">
