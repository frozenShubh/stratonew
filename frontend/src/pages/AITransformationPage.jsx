...
const AITransformationPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#020507]">
      <Helmet>
        <title>AI Transformation & Digital Strategy | Stratosport</title>
        <meta name="description" content="Transform your enterprise into an AI-first company. Stratosport delivers production AI systems, AI strategy, and end-to-end digital transformation for organizations that demand real outcomes." />
        <meta property="og:title" content="AI Transformation & Digital Strategy | Stratosport" />
        <meta property="og:description" content="Transform your enterprise into an AI-first company with production-grade AI systems, strategy, and governance." />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://stratosport.in/ai-transformation" />
      </Helmet>
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-[#0D4669]/20 via-[#020507] to-[#033051]/20 relative overflow-hidden">
        ...
        {/* Background glow */}
        <div className="absolute top-1/3 right-1/4 w-[600px] h-[600px] rounded-full opacity-[0.04]"
      ...
      <section className="py-24 bg-[#0A0D10] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
              Ready to move AI from{' '}
              <span className="bg-gradient-to-r from-[#539AC1] to-[#A5C7E0] bg-clip-text text-transparent">
                experiment to enterprise?
              </span>
            </h2>
            <p className="text-xl text-[#D9EAF6]/60 max-w-3xl mx-auto mb-8">
              Let's talk about where AI can create real leverage in your business — and build a
              path from today's state to production.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/contact">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-[#539AC1] to-[#235D94] hover:from-[#A5C7E0] hover:to-[#539AC1] text-white px-10 py-7 text-lg font-semibold transition-all duration-300 hover:shadow-[0_0_40px_rgba(83,154,193,0.4)] border-0 rounded-lg group"
                >
                  <span className="flex items-center">
