...
const GCCPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#020507]">
      <Helmet>
        <title>AI-First GCC Setup & Global Capability Centers | Stratosport</title>
        <meta name="description" content="Set up AI-first Global Capability Centers (GCCs) in India. Stratosport provides end-to-end GCC strategy, setup, and AI capability building for enterprises looking to scale engineering and AI teams." />
        <meta property="og:title" content="AI-First GCC Setup & Global Capability Centers | Stratosport" />
        <meta property="og:description" content="Build AI-first Global Capability Centers in India with production-grade engineering and AI capabilities from day one." />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://stratosport.in/gcc" />
      </Helmet>
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-[#0D4669]/20 via-[#020507] to-[#033051]/20 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-1/3 w-[700px] h-[500px] rounded-full opacity-[0.04]"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-[#D9EAF6]/60 max-w-3xl mx-auto mb-8">
              Let's discuss your goals, timeline, and team requirements — and design a GCC
              that becomes your AI competitive advantage.
            </p>
            <Link to="/contact">
              <Button
                size="lg"
